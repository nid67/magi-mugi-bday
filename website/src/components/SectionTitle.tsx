export default function SectionTitle({ level, title }: { level: string, title: string }) {
  return (
    <div className="flex flex-col mb-12 border-l-4 border-red-500 pl-6 py-2">
      <span className="font-mono text-red-500 text-sm md:text-base tracking-[0.3em] uppercase mb-2">
        Level {level}
      </span>
